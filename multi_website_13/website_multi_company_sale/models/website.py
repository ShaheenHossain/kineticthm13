...
from eagle.addons.website_sale.models.website import Website as WebsiteOriginal
...
class Website(models.Model):
    ...
    def _get_pl_partner_order(
        ...
        """The extension can be removed once a branch has following update: https://github.com/eagle/eagle/pull/26414"""
        # call undecorated super method. See eagle/tools/cache.py::ormcache and http://decorator.readthedocs.io/en/stable/tests.documentation.html#getting-the-source-code
