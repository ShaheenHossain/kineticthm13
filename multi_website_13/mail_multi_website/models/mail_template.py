...
from eagle import _, api, fields, models, tools
from eagle.exceptions import UserError
from eagle.tools import pycompat

#from eagle.addons.mail.models.mail_template import format_amount, format_date, format_tz

_logger = logging.getLogger(__name__)
FIELDS = ["body_html", "mail_server_id", "report_template"]

try:
    from eagle.addons.mail.models.mail_template import (
